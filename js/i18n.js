...
export const DICT = {
  ...
  'hint.privateProfile': { en: 'When on, only your followers can see your collection, lists and listening entries. Your name and picture stay visible so people can find and follow you.', de: 'Wenn an, sehen nur deine Follower deine Sammlung, Listen und Höreinträge. Name und Bild bleiben sichtbar, damit man dich finden und dir folgen kann.' },
  'mod.privateNote': { en: 'This profile is private. Follow to see the collection.', de: 'Dieses Profil ist privat. Folge, um die Sammlung zu sehen.' },
